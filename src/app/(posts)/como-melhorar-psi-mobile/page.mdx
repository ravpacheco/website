...
export const article = {
  ...
  description:
    'Aprenda uma dica rápida e fácil para melhorar o carregamento e o PSI de sua página web',
}
...
_(Obs.: Na data em que este artigo foi escrito o site tinha a versão antiga, disponível em [old.ravpacheco.com](http://old.ravpacheco.com))_
...
<Image
  src={beforeImg}
  alt="Resultado PSI mobile antes da otimização"
  title="Resultado PSI mobile antes da otimização"
/>
...
<Image
  src={afterImg}
  alt="Resultado PSI mobile depois da otimização"
  title="Resultado PSI mobile depois da otimização"
/>
