...
import socialNetworksImg from './social-networks.png'
import typicallInternetUserImg from './typical-internet-user.png'
...
export const article = {
  ...
  description:
    'Análise geral sobre minhas percepções em relação ao Brazil Digital Report 2019 divulgado pela McKinsey',
}
...
<Image src={typicallInternetUserImg} alt="Infográfico que apresenta o típico usuário da internet no Brasil" title="Infográfico que apresenta o típico usuário da internet no Brasil" />
...
<Image src={socialNetworksImg} alt="Dados sobre as principais redes sociais no Brasil" title="Dados sobre as principais redes sociais no Brasil" />
