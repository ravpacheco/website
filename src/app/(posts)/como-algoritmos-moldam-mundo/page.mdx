...
export const article = {
  ...
  description: 'Resenha da apresentação "How algorithms shape our world", de Kevin Slave, feita para o TED em Julho de 2011',
}
...
* SLAVIN, Kevin. "How algorithms shape our world". Edinburgh: TedGlobal, Julho 2011. Disponível em: [http://www.ted.com/talks/kevin_slavin_how_algorithms_shape_our_world](http://www.ted.com/talks/kevin_slavin_how_algorithms_shape_our_world). Acesso em: 28 maio 2015.
